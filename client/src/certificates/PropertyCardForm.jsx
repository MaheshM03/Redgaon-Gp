...
function Success({
  ...
  return (
    ...
    >
      ...
      <p style={s.stepSubtitle}>
        Property Card Application Submitted Successfully
      </p>
...
export default function PropertyCardForm() {
...
/* USE SAME STYLES FROM BIRTH CERTIFICATE FORM */
