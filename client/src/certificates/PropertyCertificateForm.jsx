...
function Success({
  ...
  return (
    ...
    >
      ...
      <p style={s.stepSubtitle}>
        Property Certificate Submitted Successfully
      </p>
...
export default function PropertyCertificateForm() {
...
/* USE SAME STYLE OBJECT FROM OTHER FORMS */
